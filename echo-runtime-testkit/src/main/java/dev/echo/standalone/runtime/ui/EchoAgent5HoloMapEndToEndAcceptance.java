...
public final class EchoAgent5HoloMapEndToEndAcceptance {
    private EchoAgent5HoloMapEndToEndAcceptance() {
    }
    ...
    public static Map<String, Object> assess(
        ...
        Map<String, Object> holomap = source.holomapValues();
        ...
        boolean interactionAccepted = Boolean.TRUE.equals(interaction.get("passed"))
                ...
                && lines.stream().anyMatch(line -> line.contains(String.valueOf(holomap.get("layer"))))
                && lines.stream().anyMatch(line -> line.contains(String.valueOf(holomap.get("marker"))))
                && lines.stream().anyMatch(line -> line.contains(String.valueOf(holomap.get("focus"))));
        ...
        result.put("layer", holomap.get("layer"));
        result.put("marker", holomap.get("marker"));
        ...
        result.put("effect", accepted
                ? "holomap_end_to_end:J->HOLOMAP:" + holomap.get("marker")
