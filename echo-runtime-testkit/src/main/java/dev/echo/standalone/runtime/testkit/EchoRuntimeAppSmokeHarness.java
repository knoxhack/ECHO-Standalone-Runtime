...
public final class EchoRuntimeAppSmokeHarness {
    ...
    public static void main(String[] args) {
        ...
        try {
            writeBootReport(workspaceRoot, headless, playableBeta, packagedTester);
    ...
    private static void writeBootReport(
        ...
        Path standaloneRoot = workspaceRoot.getFileName() != null
                && workspaceRoot.getFileName().toString().equals("echo-standalone-runtime")
                ? workspaceRoot
                : workspaceRoot.resolve("echo-standalone-runtime");
        Path report = standaloneRoot.resolve("reports/echo/standalone/runtime-app-boot-system-modules.json");
