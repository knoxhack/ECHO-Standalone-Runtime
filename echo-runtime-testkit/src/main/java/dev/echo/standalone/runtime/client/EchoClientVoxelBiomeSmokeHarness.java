...
public final class EchoClientVoxelBiomeSmokeHarness {
    ...
    public static void main(String[] args) {
        ...
        requireBiomeEnvironmentAndAmbienceSwitch(spawnBiome);
        requireBiomeEnvironmentCache(spawnBiome);
        requireRenderPacketBiomeTint(world, spawnBiome);
        requireAtlasSourceSignatureTracksMaterialInputs(world, spawnSample);
        requireAtlasSourceCacheSkipsUnchangedChunks(world, spawnSample);
        requireAtlasSourceIgnoresRuntimeOnlyMachineMetadata(world, spawnSample);
    ...
    private static void requireBiomeEnvironmentAndAmbienceSwitch(EchoVoxelBiome spawnBiome) {
    ...
    private static void requireBiomeEnvironmentCache(EchoVoxelBiome spawnBiome) {
    ...
    private static void requireRenderPacketBiomeTint(EchoVoxelWorld world, EchoVoxelBiome spawnBiome) {
    ...
    private static void requireAtlasSourceSignatureTracksMaterialInputs(EchoVoxelWorld world, BlockSample sample) {
    ...
    private static void requireAtlasSourceCacheSkipsUnchangedChunks(EchoVoxelWorld world, BlockSample sample) {
    ...
    private static void requireAtlasSourceIgnoresRuntimeOnlyMachineMetadata(EchoVoxelWorld world, BlockSample sample) {
