...
public final class EchoAgent5IndexEndToEndAcceptanceSmoke {
    private EchoAgent5IndexEndToEndAcceptanceSmoke() {
    }
    ...
    public static Map<String, Object> capture(EchoAgent5UiDataSources dataSources) {
        ...
        Map<String, Object> accepted = EchoAgent5IndexEndToEndAcceptance.assess(
                hotkey,
                physicalInput,
                render,
                focus,
        ...
        Map<String, Object> rejectedNoInput = EchoAgent5IndexEndToEndAcceptance.assess(
                hotkey,
        ...
        Map<String, Object> rejectedNoRender = EchoAgent5IndexEndToEndAcceptance.assess(
                hotkey,
                physicalInput,
                Map.of("accepted", false, "surface", "INDEX"),
                focus,
        ...
        Map<String, Object> rejectedNoSearch = EchoAgent5IndexEndToEndAcceptance.assess(
                hotkey,
                physicalInput,
                render,
                focus,
                Map.of("passed", false, "indexBuffer", source.indexQuery()),
                transcript,
                source
        );
        Map<String, Object> rejectedNoTranscript = EchoAgent5IndexEndToEndAcceptance.assess(
                hotkey,
                physicalInput,
                render,
                focus,
        ...
        boolean passed = Boolean.TRUE.equals(accepted.get("accepted"))
                && "index_end_to_end:G->INDEX:ashfall".equals(accepted.get("effect"))
        ...
        smoke.put("indexEndToEndAcceptanceSmokeClass",
                EchoAgent5IndexEndToEndAcceptanceSmoke.class.getSimpleName());
